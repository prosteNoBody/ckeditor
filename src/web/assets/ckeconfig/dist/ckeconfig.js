import "ckeditor5";
import { create, allPlugins } from "@craftcms/ckeditor";
/**
...
const ToolbarBuilder = Garnish.Base.extend({
  ...
  closestItem: null,
  init: function(id2, containerId, configOptions, namespace) {
    this.$container = $(`#${id2}`);
    ...
    create(editorElement, {
      ...
      for (const componentName of cf.names()) {
        this.components[componentName] = cf.create(componentName);
      }
